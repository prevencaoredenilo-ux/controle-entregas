const CACHE = 'orbita-v2-cache-16';
const ASSETS = [
  './', './index.html', './styles.css?v=3.3', './app.js?v=3.3', './db.js?v=3.3', './helpers.js?v=3.3', './views.js?v=3.3', './excel-report.js?v=3.3', './manifest.webmanifest?v=3.3',
