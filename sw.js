const CACHE = 'orbita-v2-cache-13';
const ASSETS = [
  './', './index.html', './styles.css?v=3.0', './app.js?v=3.0', './db.js?v=3.0', './helpers.js?v=3.0', './views.js?v=3.0', './excel-report.js?v=3.0', './manifest.webmanifest?v=3.0',
