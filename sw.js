const CACHE = 'orbita-v2-cache-28';
const ASSETS = [
  './', './index.html', './styles.css?v=5.7', './app.js?v=5.7', './db.js?v=5.7', './helpers.js?v=5.7', './views.js?v=5.7', './excel-report.js?v=5.7', './manifest.webmanifest?v=5.7',
