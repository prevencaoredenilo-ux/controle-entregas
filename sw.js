const CACHE = 'orbita-v2-cache-12';
const ASSETS = [
  './', './index.html', './styles.css?v=2.9', './app.js?v=2.9', './db.js?v=2.9', './helpers.js?v=2.9', './views.js?v=2.9', './excel-report.js?v=2.9', './manifest.webmanifest?v=2.9',
