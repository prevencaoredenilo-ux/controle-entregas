const CACHE = 'orbita-v2-cache-19';
const ASSETS = [
  './', './index.html', './styles.css?v=3.6', './app.js?v=3.6', './db.js?v=3.6', './helpers.js?v=3.6', './views.js?v=3.6', './excel-report.js?v=3.6', './manifest.webmanifest?v=3.6',
