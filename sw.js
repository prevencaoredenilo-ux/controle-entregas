const CACHE = 'orbita-v2-cache-29';
const ASSETS = [
  './', './index.html', './styles.css?v=5.8', './app.js?v=5.8', './db.js?v=5.8', './helpers.js?v=5.8', './views.js?v=5.8', './excel-report.js?v=5.8', './manifest.webmanifest?v=5.8',
