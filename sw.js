const CACHE = 'orbita-v2-cache-22';
const ASSETS = [
  './', './index.html', './styles.css?v=4.2', './app.js?v=4.2', './db.js?v=4.2', './helpers.js?v=4.2', './views.js?v=4.2', './excel-report.js?v=4.2', './manifest.webmanifest?v=4.2',
