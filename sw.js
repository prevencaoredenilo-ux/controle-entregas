const CACHE = 'orbita-v2-cache-21';
const ASSETS = [
  './', './index.html', './styles.css?v=4.1', './app.js?v=4.1', './db.js?v=4.1', './helpers.js?v=4.1', './views.js?v=4.1', './excel-report.js?v=4.1', './manifest.webmanifest?v=4.1',
