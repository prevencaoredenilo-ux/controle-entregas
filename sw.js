const CACHE = 'orbita-v2-cache-14';
const ASSETS = [
  './', './index.html', './styles.css?v=3.1', './app.js?v=3.1', './db.js?v=3.1', './helpers.js?v=3.1', './views.js?v=3.1', './excel-report.js?v=3.1', './manifest.webmanifest?v=3.1',
