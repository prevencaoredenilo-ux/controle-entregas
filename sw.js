const CACHE = 'orbita-v2-cache-15';
const ASSETS = [
  './', './index.html', './styles.css?v=3.2', './app.js?v=3.2', './db.js?v=3.2', './helpers.js?v=3.2', './views.js?v=3.2', './excel-report.js?v=3.2', './manifest.webmanifest?v=3.2',
