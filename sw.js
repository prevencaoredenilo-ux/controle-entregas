const CACHE = 'orbita-v2-cache-17';
const ASSETS = [
  './', './index.html', './styles.css?v=3.4', './app.js?v=3.4', './db.js?v=3.4', './helpers.js?v=3.4', './views.js?v=3.4', './excel-report.js?v=3.4', './manifest.webmanifest?v=3.4',
