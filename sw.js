const CACHE = 'orbita-v2-cache-23';
const ASSETS = [
  './', './index.html', './styles.css?v=4.4', './app.js?v=4.4', './db.js?v=4.4', './helpers.js?v=4.4', './views.js?v=4.4', './excel-report.js?v=4.4', './manifest.webmanifest?v=4.4',
