...
3. Confira no rodapé se aparece **V14.3.5**.
...
- pesquisa na tela Pesquisar Entregas por nº do cupom, data, DOC, caixa e nome do cliente;
...
A V14.3.5 mantém os dados da V14.3.4, V14.3.3, V14.3.2, V14.3.1, V14.3, V14.2, V14.1, V14, V13 e das versões anteriores reconhecidas pelo sistema. Os novos filtros e o ajuste visual não modificam os registros armazenados. Na primeira abertura, nenhuma entrega, ciclo, custo, KM, configuração ou histórico é apagado. Backups de uma versão futura são bloqueados para evitar perda de informações.
