...
3. Confira no rodapé se aparece **V14.4.0**.
...
A V14.4.0 mantém os dados da V14.3.8, V14.3.7, V14.3.6, V14.3.5, V14.3.4, V14.3.3, V14.3.2, V14.3.1, V14.3, V14.2, V14.1, V14, V13 e das versões anteriores reconhecidas pelo sistema. Os novos gráficos, formatos e indicadores são calculados a partir dos dados existentes e não modificam os registros armazenados. Na primeira abertura, nenhuma entrega, ciclo, custo, KM, configuração ou histórico é apagado. Backups de uma versão futura são bloqueados para evitar perda de informações.
