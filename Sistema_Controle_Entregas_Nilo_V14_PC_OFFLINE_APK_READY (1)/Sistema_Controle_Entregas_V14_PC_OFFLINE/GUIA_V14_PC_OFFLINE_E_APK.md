...
6. Se o celular não conseguir conectar, execute `LIBERAR_REDE_LOCAL_PORTA_8765.bat` como Administrador. A regra é criada apenas para o perfil de rede privada do Windows.
