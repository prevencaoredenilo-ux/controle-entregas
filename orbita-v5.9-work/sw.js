const CACHE = 'orbita-v2-cache-30';
const ASSETS = [
  './', './index.html', './styles.css?v=5.9', './app.js?v=5.9', './db.js?v=5.9', './helpers.js?v=5.9', './views.js?v=5.9', './excel-report.js?v=5.9', './manifest.webmanifest?v=5.9',
